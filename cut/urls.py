...
urlpatterns = [
    ...
    path('lay_detail/<int:pk>/red3',lay_detail_view_red3, name='red3'),
    path('lay_detail/<int:pk>/blue3',lay_detail_view_blue3, name='blue3'),
    path('lay_detail/<int:pk>/yellow3',lay_detail_view_yellow3, name='yellow3'),
